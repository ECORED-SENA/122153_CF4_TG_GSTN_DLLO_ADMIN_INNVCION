    ...
    .row.justify-content-center
        .col-lg-10
          .titulo-sexto.color-acento-contenido
            p.mb-0 #[b Figura 2.] Ejemplo ciclo del servicio

        .col-lg-10.mb-5
          .row.justify-content-center.fnd-11
            .col-lg-10
              figure.my-5
                img(src='@/assets/curso/temas/tema2/img-3.svg', alt='Ejemplo ciclo del servicio. La imagen muestra la representación gráfica del ciclo de la prestación de servicio en un restaurante, resaltando los momentos de verdad NO CRÍTICOS y los momentos de verdad CRÍTICOS. Los momentos no críticos son: facilidades de parqueo, servicio inicial, espera por la carta, atención durante el consumo, espera por la cuenta, pago de la cuenta y despedida. Los momentos críticos son: aspecto general del lugar, recepción y ubicación, toma del pedido, espera por el servicio y características organolépticas de la comida.')
