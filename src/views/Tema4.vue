...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-sexto.color-acento-contenido
      p.mb-0 #[b Figura 3.] Proceso de comunicación organizacional formal

    figure.mb-5
      img(src='@/assets/curso/temas/tema4/img-2.svg', alt='Proceso de comunicación organizacional formal. Se presenta un gráfico que muestra la jerarquía de comunicación de la organización de acuerdo a los niveles de autoridad. Esta jerarquía incluye la comunicación descendente, ascendente, horizontal y diagonal.')
    ...
    .row.fnd-11.justify-content-center
      .col-lg-11.mt-5
        .titulo-sexto.color-acento-contenido
          p.mb-0 #[b Figura 4.] Ejemplo de la estructuración de la matriz de comunicaciones
        figure.mb-5
          img(src='@/assets/curso/temas/tema4/img-10.svg', alt='Ejemplo de la estructuración de la matriz de comunicaciones. Se presenta una matriz en formato Excel que ejemplifica un plan de comunicación. Este plan tiene en cuenta objetivos estratégicos, grupos de interés, acciones, prioridades, cronograma, responsables y recursos.')
