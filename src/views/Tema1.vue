...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-sexto.color-acento-contenido.mb5
      p.mb-0 #[b Figura 1.] Pirámide de Maslow
    ...
    .row.fnd-11.mb-5
      ...
      .row.justify-content-center.mb-5
        .col-md-8.col-lg-10
          igure
            img(src='@/assets/curso/temas/tema1/img-3.svg', alt='La pirámide de Maslow, Pirámide que representa los niveles de las necesidades humanas: Nivel 1: necesidades fisiológicas como respirar, comer, beber, dormir y sexualidad. Nivel 2: representa la necesidad de seguridad física, laboral y económica. Nivel 3: aquí se encuentran las necesidades sociales tales como la pertenencia a un grupo, la amistad, el amor y el afecto. Nivel 4: en este se encuentra la necesidad de reconocimiento, que se traduce en la valoración de los demás, el éxito y el respeto. Nivel 5: en este nivel se encuentran las necesidades de autorrealización, siendo una de estas, la satisfacción personal.')
